            ...
            <div class="container">
                <div class="row">
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">ঠিকানা</h5>
                                        <span class="text-white">House #5, Basundhara</span> <br>
										<span class="text-white">Block F, Sadek Road</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">মোবাইল</h5>
                                        <span class="d-table text-white">+880 1797 622 411</span>
										<span class="text-white">+880 1773 265 863 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">ইমেইল</h5>
										<span class="d-table text-white">mostofa.anik@northsouth.edu</span>
										<span class="text-white"> agents@baribhara.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-12 col-lg-7">
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<h2 class="text-secondary double-down-line text-center mb-5">আপনার মন্তবা</h2>
