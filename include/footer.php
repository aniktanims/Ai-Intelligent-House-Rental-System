<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom" src="images/logo/logo.png" height='200px' alt="image"></a> </div>
                                        <p class="pb-20 text-white">বসুন্ধরা এলাকায় বাসা ভাড়া বা প্রোপার্টি বিক্রয় নিয়ে সমস্যা আর নয় । আমরা আছি আপনাদের সাথে</p>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Bashundhara Bari Bhara - 2023</span> </div>
                    <div class="col-sm-6">
                        <ul class="line-menu text-white hover-text-primary float-right">
                            <li><a href="#">GROUP 6 </a></li>
                            <li>|</li>
                            <li><a href="#"> CSE299 | TNR</a></li>
                        </ul>
                    </div>
                </div>
            </div>
